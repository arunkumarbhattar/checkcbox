...
//
// RUN: %clang %s -o %t1 -Werror -Wno-unused-value -Wno-check-bounds-decls-unchecked-scope %checkcbox_target_flags
// RUN: %checkcbox_rununder %t1 1 | FileCheck %s --check-prefixes=CHECK,NO-BOUNDS-FAILURES-1
// RUN: %checkcbox_rununder %t1 2 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 3 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 4 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 5 | FileCheck %s --check-prefixes=CHECK,NO-BOUNDS-FAILURES-2
// RUN: %checkcbox_rununder %t1 6 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 7 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 8 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 9 | FileCheck %s --check-prefixes=CHECK,NO-BOUNDS-FAILURES-3
// RUN: %checkcbox_rununder %t1 10 | FileCheck %s --check-prefixes=CHECK
//
// RUN: %checkcbox_rununder %t1 21 | FileCheck %s --check-prefixes=CHECK,NO-BOUNDS-FAILURES-4
// RUN: %checkcbox_rununder %t1 22 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 23 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 24 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 25 | FileCheck %s --check-prefixes=CHECK,NO-BOUNDS-FAILURES-5
// RUN: %checkcbox_rununder %t1 26 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 27| FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 28 | FileCheck %s --check-prefixes=CHECK

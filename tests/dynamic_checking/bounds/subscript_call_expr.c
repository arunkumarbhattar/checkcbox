...
//
// RUN: %clang %s -o %t1 -Werror -Wno-unused-value %checkcbox_target_flags
//
//
...
//
//
// RUN: %checkcbox_rununder %t1 constant_bounds read 5 | FileCheck %s --check-prefixes=CB-READ-START,CB-READ-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds read  -1 | FileCheck %s --check-prefixes=CB-READ-START,CB-READ-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds read 4 | FileCheck %s --check-prefixes=CB-READ-START,CB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 constant_bounds read 0 | FileCheck %s --check-prefixes=CB-READ-START,CB-READ-SUCCESS
// Make sure we aren't accidentally running the bounds-safe interface verison of this test.
// RUN: %checkcbox_rununder %t1 constant_bounds read 0 | FileCheck %s --check-prefixes=CB-READ-START,CB-READ-SUCCESS,CHECK-BSI-NOT
//
// RUN: %checkcbox_rununder %t1 constant_bounds write 5| FileCheck %s --check-prefixes=CB-WRITE-START,CB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds write -1 | FileCheck %s --check-prefixes=CB-WRITE-START,CB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds write 4 | FileCheck %s --check-prefixes=CB-WRITE-START,CB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 constant_bounds write 0 | FileCheck %s --check-prefixes=CB-WRITE-START,CB-WRITE-SUCCESS
//.
// RUN: %checkcbox_rununder %t1 constant_bounds inc 7| FileCheck %s --check-prefixes=CB-INC-START,CB-INC-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds inc -2 | FileCheck %s --check-prefixes=CB-INC-START,CB-INC-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds inc 4 | FileCheck %s --check-prefixes=CB-INC-START,CB-INC-SUCCESS
// RUN: %checkcbox_rununder %t1 constant_bounds inc 0 | FileCheck %s --check-prefixes=CB-INC-START,CB-INC-SUCCESS
//
// RUN: %checkcbox_rununder %t1 constant_bounds compound 1000| FileCheck %s --check-prefixes=CB-COMPOUND-START,CB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds compound -146 | FileCheck %s --check-prefixes=CB-COMPOUND-START,CB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 constant_bounds compound 4 | FileCheck %s --check-prefixes=CB-COMPOUND-START,CB-COMPOUND-SUCCESS
// RUN: %checkcbox_rununder %t1 constant_bounds compound 0 | FileCheck %s --check-prefixes=CB-COMPOUND-START,CB-COMPOUND-SUCCESS
//
//
...
//
//
// RUN: %checkcbox_rununder %t1 dependent_bounds read 2 5 | FileCheck %s --check-prefixes=DB-READ-START,DB-READ-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds read 3 -1 | FileCheck %s --check-prefixes=DB-READ-START,DB-READ-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds read 5 4 | FileCheck %s --check-prefixes=DB-READ-START,DB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 dependent_bounds read 10 0 | FileCheck %s --check-prefixes=DB-READ-START,DB-READ-SUCCESS
//
// RUN: %checkcbox_rununder %t1 dependent_bounds write 6 6 | FileCheck %s --check-prefixes=DB-WRITE-START,DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds write 11 -1 | FileCheck %s --check-prefixes=DB-WRITE-START,DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds write 3 2 | FileCheck %s --check-prefixes=DB-WRITE-START,DB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 dependent_bounds write 3 0 | FileCheck %s --check-prefixes=DB-WRITE-START,DB-WRITE-SUCCESS
//
// RUN: %checkcbox_rununder %t1 dependent_bounds inc 5 -1 | FileCheck %s --check-prefixes=DB-INC-START,DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds inc 5 5 | FileCheck %s --check-prefixes=DB-INC-START,DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds inc 12 11 | FileCheck %s --check-prefixes=DB-INC-START,DB-INC-SUCCESS
// RUN: %checkcbox_rununder %t1 dependent_bounds inc 12 0 | FileCheck %s --check-prefixes=DB-INC-START,DB-INC-SUCCESS
//
// RUN: %checkcbox_rununder %t1 dependent_bounds compound 50 1000| FileCheck %s --check-prefixes=DB-COMPOUND-START,DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 dependent_bounds compound 50 -146 | FileCheck %s --check-prefixes=DB-COMPOUND-START,DB-COMPOUND-FAIL
// RUN %checkcbox_rununder %t1 dependent_bounds compound 10 9 | FileCheck %s --check-prefixes=DB-COMPOUND-START,DB-COMPOUND-SUCCESS
// RUN %checkcbox_rununder %t1 dependent_bounds compound 10 0 | FileCheck %s --check-prefixes=DB-COMPOUND-START,DB-COMPOUND-SUCCESS
//
//
...
//
//
// RUN: %checkcbox_rununder %t1 nt_constant_bounds read 6 | FileCheck %s --check-prefixes=NT-CB-READ-START,NT-CB-READ-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds read -1 | FileCheck %s --check-prefixes=NT-CB-READ-START,NT-CB-READ-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds read 5 | FileCheck %s --check-prefixes=NT-CB-READ-START,NT-CB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_constant_bounds read 4 | FileCheck %s --check-prefixes=NT-CB-READ-START,NT-CB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_constant_bounds read 0 | FileCheck %s --check-prefixes=NT-CB-READ-START,NT-CB-READ-SUCCESS
//
// 4th argument = value to write.
// RUN: %checkcbox_rununder %t1 nt_constant_bounds write 6 5| FileCheck %s --check-prefixes=NT-CB-WRITE-START,NT-CB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds write -1 5 | FileCheck %s --check-prefixes=NT-CB-WRITE-START,NT-CB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds write 5 0| FileCheck %s --check-prefixes=NT-CB-WRITE-START,NT-CB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_constant_bounds write 4 5| FileCheck %s --check-prefixes=NT-CB-WRITE-START,NT-CB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_constant_bounds write 0 5| FileCheck %s --check-prefixes=NT-CB-WRITE-START,NT-CB-WRITE-SUCCESS
//
// The next test line tries to increment the null terminator.
// RUN: %checkcbox_rununder %t1 nt_constant_bounds inc 5 | FileCheck %s --check-prefixes=NT-CB-INC-START,NT-CB-INC-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds inc 7| FileCheck %s --check-prefixes=NT-CB-INC-START,NT-CB-INC-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds inc -2 | FileCheck %s --check-prefixes=NT-CB-INC-START,NT-CB-INC-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds inc 4 | FileCheck %s --check-prefixes=NT-CB-INC-START,NT-CB-INC-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_constant_bounds inc 0 | FileCheck %s --check-prefixes=NT-CB-INC-START,NT-CB-INC-SUCCESS
//
// The next test line tries to do a compound assignment on the null terminator.
// RUN: %checkcbox_rununder %t1 nt_constant_bounds compound 5 | FileCheck %s --check-prefixes=NT-CB-COMPOUND-START,NT-CB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds compound 1000| FileCheck %s --check-prefixes=NT-CB-COMPOUND-START,NT-CB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds compound -146 | FileCheck %s --check-prefixes=NT-CB-COMPOUND-START,NT-CB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 nt_constant_bounds compound 4 | FileCheck %s --check-prefixes=NT-CB-COMPOUND-START,NT-CB-COMPOUND-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_constant_bounds compound 0 | FileCheck %s --check-prefixes=NT-CB-COMPOUND-START,NT-CB-COMPOUND-SUCCESS
//
//
...
//
//
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds read 2 5 | FileCheck %s --check-prefixes=NT-DB-READ-START,NT-DB-READ-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds read 3 -1 | FileCheck %s --check-prefixes=NT-DB-READ-START,NT-DB-READ-FAIL
// Test reading null-terminator.
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds read 5 5 | FileCheck %s --check-prefixes=NT-DB-READ-START,NT-DB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds read 5 4 | FileCheck %s --check-prefixes=NT-DB-READ-START,NT-DB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds read 10 0 | FileCheck %s --check-prefixes=NT-DB-READ-START,NT-DB-READ-SUCCESS
//
// 5th argument = value to write.
// Test trying to overwrite null terminator with a non-zero value.
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 6 6 100 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 6 10 15 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 6 10 0  | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 11 -1 10 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 11 -1 0 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-FAIL
// Test overwriting the null terminator with 0
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 6 6 0 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 6 5 25 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds write 3 0 10 | FileCheck %s --check-prefixes=NT-DB-WRITE-START,NT-DB-WRITE-SUCCESS
//
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds inc 5 -1 | FileCheck %s --check-prefixes=NT-DB-INC-START,NT-DB-INC-FAIL
// Try to do a compound assignment on the null terminator.
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds inc 5 5 | FileCheck %s --check-prefixes=NT-DB-INC-START,NT-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds inc 20 21 | FileCheck %s --check-prefixes=NT-DB-INC-START,NT-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds inc 12 11 | FileCheck %s --check-prefixes=NT-DB-INC-START,NT-DB-INC-SUCCESS
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds inc 12 0 | FileCheck %s --check-prefixes=NT-DB-INC-START,NT-DB-INC-SUCCESS
//
// Try to do a compound assignment on the null element.
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds compound 50 50 | FileCheck %s --check-prefixes=NT-DB-COMPOUND-START,NT-DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds compound 50 1000| FileCheck %s --check-prefixes=NT-DB-COMPOUND-START,NT-DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 nt_dependent_bounds compound 50 -146 | FileCheck %s --check-prefixes=NT-DB-COMPOUND-START,NT-DB-COMPOUND-FAIL
// RUN %checkcbox_rununder %t1 nt_dependent_bounds compound 10 9 | FileCheck %s --check-prefixes=NT-DB-COMPOUND-START,NT-DB-COMPOUND-SUCCESS
// RUN %checkcbox_rununder %t1 nt_dependent_bounds compound 10 0 | FileCheck %s --check-prefixes=NT-DB-COMPOUND-START,NT-DB-COMPOUND-SUCCESS
//
//
// Test operations on a pointer with bounds dependent on the value of an argument n. The pointer points
...
//
// RUN: %checkcbox_rununder %t1 md_dependent_bounds read 2 2 0   | FileCheck %s --check-prefixes=MD-DB-READ-START,MD-DB-READ-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds read 3 -1 1  | FileCheck %s --check-prefixes=MD-DB-READ-START,MD-DB-READ-FAIL
// This results in an access outside of the 2d array, so it fails.
// RUN: %checkcbox_rununder %t1 md_dependent_bounds read 3 1 6   | FileCheck %s --check-prefixes=MD-DB-READ-START,MD-DB-READ-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds read 5 4 2  | FileCheck %s --check-prefixes=MD-DB-READ-START,MD-DB-READ-SUCCESS
// RUN: %checkcbox_rununder %t1 md_dependent_bounds read 10 0 3 | FileCheck %s --check-prefixes=MD-DB-READ-START,MD-DB-READ-SUCCESS
// This is still within the entire array, it is allowed.
// RUN: %checkcbox_rununder %t1 md_dependent_bounds read 10 0 4 | FileCheck %s --check-prefixes=MD-DB-READ-START,MD-DB-READ-SUCCESS
//
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 6 6 2 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 6 5 3 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 11 -1 2 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 6 5 2 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 6 5 0 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-SUCCESS
// The access is still within the entire array, so it is allowed.
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 3 0 5 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-SUCCESS
// RUN: %checkcbox_rununder %t1 md_dependent_bounds write 3 0 0 | FileCheck %s --check-prefixes=MD-DB-WRITE-START,MD-DB-WRITE-SUCCESS
//
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 5 -1 0 | FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 5 5 0 | FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 5 0 -1 | FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 5 4 4 | FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 12 11 3| FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 12 11 0 | FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-SUCCESS
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 12 11 2| FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-SUCCESS
// RUN: %checkcbox_rununder %t1 md_dependent_bounds inc 12 0 0 | FileCheck %s --check-prefixes=MD-DB-INC-START,MD-DB-INC-SUCCESS
//
// These fail because the function call returns a null pointer.
// RUN: %checkcbox_rununder %t1 md_dependent_bounds compound 50 1000 0| FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds compound 50 -146 5 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-FAIL
// These fail because of a bounds error.
// RUN: %checkcbox_rununder %t1 md_dependent_bounds compound 50 50 0 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds compound 50 49 4 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds compound 50 48 6 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-FAIL
// RUN: %checkcbox_rununder %t1 md_dependent_bounds compound 50 -1 0 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-FAIL
// RUN %checkcbox_rununder %t1 md_dependent_bounds compound 10 9 3 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-SUCCESS
// RUN %checkcbox_rununder %t1 md_dependent_bounds compound 10 0 0 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-SUCCESS
// RUN %checkcbox_rununder %t1 md_dependent_bounds compound 50 1 1 | FileCheck %s --check-prefixes=MD-DB-COMPOUND-START,MD-DB-COMPOUND-SUCCESS

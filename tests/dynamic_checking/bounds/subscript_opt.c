...
//
// RUN: %clang %S/subscript.c -DTEST_READ -o %t1 -Werror -Wno-unused-value -O3 %checkcbox_target_flags
...
//
// RUN: %clang %S/subscript.c -DTEST_WRITE -o %t2 -Werror -O3 %checkcbox_target_flags
...
//
// RUN: %clang %S/subscript.c -DTEST_INCREMENT -o %t3 -Werror -O3 %checkcbox_target_flags
...
//
// RUN: %clang %S/subscript.c -DTEST_COMPOUND_ASSIGN -o %t4 -Werror -O3 %checkcbox_target_flags

...
// RUN: %checkcbox_rununder %t1 0 | FileCheck %s --check-prefixes=CHECK,NO-BOUNDS-FAILURES
// RUN: %checkcbox_rununder %t1 1 | FileCheck %s --check-prefixes=CHECK
...
// RUN: %checkcbox_rununder %t1 5 | FileCheck %s --check-prefixes=CHECK
...
// RUN: %checkcbox_rununder %t1 9 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 10 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 11 | FileCheck %s --check-prefixes=CHECK
// RUN: %checkcbox_rununder %t1 12 | FileCheck %s --check-prefixes=CHECK

...
//
// RUN: %clang %s -o %t1 -DTEST_READ -Werror -Wno-unused-value -Wno-check-bounds-decls-unchecked-scope %checkcbox_target_flags
...
//
// RUN: %clang %s -o %t2 -DTEST_WRITE -Werror -Wno-check-bounds-decls-unchecked-scope %checkcbox_target_flags
...
// RUN: %clang %s -o %t3 -DTEST_INCREMENT -Werror -Wno-check-bounds-decls-unchecked-scope %checkcbox_target_flags
...
// RUN: %clang %s -o %t4 -DTEST_COMPOUND_ASSIGN -Werror -Wno-check-bounds-decls-unchecked-scope %checkcbox_target_flags
